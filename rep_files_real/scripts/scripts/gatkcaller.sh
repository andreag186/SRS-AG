...
gatk SplitIntervals -R ${REFERENCEFILE} --scatter-count $CORES -L NC_052612.1 -L NC_052613.1 -L NC_052614.1 -L NC_052615.1 -L NC_052616.1 -L NC_052617.1 -L NC_052618.1 -L NC_052619.1 -L NC_052620.1 -L NC_052621.1 -L NC_052622.1 -O ${SCATTEREDINTERVALDIR}
